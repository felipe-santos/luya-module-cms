...
(function () {
  ...
  zaa.controller("NavController", ['$scope', '$rootScope', '$filter', '$state', '$stateParams', '$http', 'PlaceholderService', 'ServicePropertiesData', 'ServiceMenuData', 'ServiceLanguagesData', 'ServiceLiveEditMode', 'AdminToastService', 'AdminClassService', 'AdminLangService', 'HtmlStorage', function ($scope, $rootScope, $filter, $state, $stateParams, $http, PlaceholderService, ServicePropertiesData, ServiceMenuData, ServiceLanguagesData, ServiceLiveEditMode, AdminToastService, AdminClassService, AdminLangService, HtmlStorage) {
    ...
    function initializer() {
      ...
      if ($scope.navData == undefined) {
        ...
        $scope.$watch(function () {
          return $scope.navData.is_header;
        }, function (n, o) {
          if (n !== o && n !== undefined) {
            $http.get('admin/api-cms-nav/toggle-header', {
              params: {
                navId: $scope.navData.id,
                headerState: n
              }
              ...
              $scope.menuDataReload().then(function () {
                if ($scope.navData.is_header == 1) {
                  AdminToastService.success(i18nParam('js_state_is_header', {
                    title: $scope.navData.title
                  }));
                } else {
                  AdminToastService.success(i18nParam('js_state_is_not_header', {
                    title: $scope.navData.title
                  }));
                }
        ...
        $scope.$watch(function () {
          return $scope.navData.is_footer;
        }, function (n, o) {
          if (n !== o && n !== undefined) {
            $http.get('admin/api-cms-nav/toggle-footer', {
              params: {
                navId: $scope.navData.id,
                footerState: n
              }
              ...
              $scope.menuDataReload().then(function () {
                if ($scope.navData.is_footer == 1) {
                  AdminToastService.success(i18nParam('js_state_is_footer', {
                    title: $scope.navData.title
                  }));
                } else {
                  AdminToastService.success(i18nParam('js_state_is_not_footer', {
                    title: $scope.navData.title
                  }));
                }
        ...
        $scope.$watch(function () {
          return $scope.navData.is_menu_panel;
        }, function (n, o) {
          if (n !== o && n !== undefined) {
            $http.get('admin/api-cms-nav/toggle-menu-panel', {
              params: {
                navId: $scope.navData.id,
                menuPanelState: n
              }
              ...
              $scope.menuDataReload().then(function () {
                if ($scope.navData.is_menu_panel == 1) {
                  AdminToastService.success(i18nParam('js_state_is_menu_panel', {
                    title: $scope.navData.title
                  }));
                } else {
                  AdminToastService.success(i18nParam('js_state_is_not_menu_panel', {
                    title: $scope.navData.title
                  }));
                }
        ...
        $scope.$watch(function () {
          return $scope.navData.is_home_panel;
        }, function (n, o) {
          if (n !== o && n !== undefined) {
            $http.get('admin/api-cms-nav/toggle-home-panel', {
              params: {
                navId: $scope.navData.id,
                homePanelState: n
              }
              ...
              $scope.menuDataReload().then(function () {
                if ($scope.navData.is_home_panel == 1) {
                  AdminToastService.success(i18nParam('js_state_is_home_panel', {
                    title: $scope.navData.title
                  }));
                } else {
                  AdminToastService.success(i18nParam('js_state_is_not_home_panel', {
                    title: $scope.navData.title
                  }));
                }
        ...
        $scope.$watch(function () {
          return $scope.navData.is_footer_panel;
        }, function (n, o) {
          if (n !== o && n !== undefined) {
            $http.get('admin/api-cms-nav/toggle-footer-panel', {
              params: {
                navId: $scope.navData.id,
                footerPanelState: n
              }
              ...
              $scope.menuDataReload().then(function () {
                if ($scope.navData.is_footer_panel == 1) {
                  AdminToastService.success(i18nParam('js_state_is_footer_panel', {
                    title: $scope.navData.title
                  }));
                } else {
                  AdminToastService.success(i18nParam('js_state_is_not_footer_panel', {
                    title: $scope.navData.title
                  }));
                }
        ...
        $scope.$watch(function () {
          return $scope.navData.is_banner_mini;
        }, function (n, o) {
          if (n !== o && n !== undefined) {
            $http.get('admin/api-cms-nav/toggle-banner-mini', {
              params: {
                navId: $scope.navData.id,
                bannerMiniState: n
              }
              ...
              $scope.menuDataReload().then(function () {
                if ($scope.navData.is_banner_mini == 1) {
                  AdminToastService.success(i18nParam('js_state_is_banner_mini', {
                    title: $scope.navData.title
                  }));
                } else {
                  AdminToastService.success(i18nParam('js_state_is_not_banner_mini', {
                    title: $scope.navData.title
                  }));
                }
        ...
        $scope.$watch(function () {
          return $scope.navData.is_banner;
        }, function (n, o) {
          if (n !== o && n !== undefined) {
            $http.get('admin/api-cms-nav/toggle-banner', {
              params: {
                navId: $scope.navData.id,
                bannerState: n
              }
              ...
              $scope.menuDataReload().then(function () {
                if ($scope.navData.is_banner == 1) {
                  AdminToastService.success(i18nParam('js_state_is_banner', {
                    title: $scope.navData.title
                  }));
                } else {
                  AdminToastService.success(i18nParam('js_state_is_not_banner', {
                    title: $scope.navData.title
                  }));
                }
        ...
        $scope.$watch(function () {
          return $scope.navData.is_popup_login;
        }, function (n, o) {
          if (n !== o && n !== undefined) {
            $http.get('admin/api-cms-nav/toggle-popup-login', {
              params: {
                navId: $scope.navData.id,
                popupLoginState: n
              }
              ...
              $scope.menuDataReload().then(function () {
                if ($scope.navData.is_popup_login == 1) {
                  AdminToastService.success(i18nParam('js_state_is_popup_login', {
                    title: $scope.navData.title
                  }));
                } else {
                  AdminToastService.success(i18nParam('js_state_is_not_popup_login', {
                    title: $scope.navData.title
                  }));
                }
        ...
        $scope.$watch(function () {
          return $scope.navData.is_popup;
        }, function (n, o) {
          if (n !== o && n !== undefined) {
            $http.get('admin/api-cms-nav/toggle-popup', {
              params: {
                navId: $scope.navData.id,
                popupState: n
              }
              ...
              $scope.menuDataReload().then(function () {
                if ($scope.navData.is_popup == 1) {
                  AdminToastService.success(i18nParam('js_state_is_popup', {
                    title: $scope.navData.title
                  }));
                } else {
                  AdminToastService.success(i18nParam('js_state_is_not_popup', {
                    title: $scope.navData.title
                  }));
                }
  ...
  zaa.controller("NavItemController", ['$scope', '$rootScope', '$http', '$filter', '$timeout', 'ServiceMenuData', 'AdminLangService', 'AdminToastService', 'ServiceLiveEditMode', 'ServiceLayoutsData', 'ServiceWorkingPageVersion', function ($scope, $rootScope, $http, $filter, $timeout, ServiceMenuData, AdminLangService, AdminToastService, ServiceLiveEditMode, ServiceLayoutsData, ServiceWorkingPageVersion) {
    ...
    $scope.updateNavItemData = function (itemCopy, typeDataCopy) {
      ...
      typeDataCopy.has_header = itemCopy.has_header;
      typeDataCopy.has_footer = itemCopy.has_footer;
      typeDataCopy.has_header_panel = itemCopy.has_header_panel;
      typeDataCopy.has_footer_panel = itemCopy.has_footer_panel;
      typeDataCopy.has_menu_panel = itemCopy.has_menu_panel;
      typeDataCopy.has_banner = itemCopy.has_banner;
      typeDataCopy.has_banner_mini = itemCopy.has_banner_mini;
      typeDataCopy.has_popup = itemCopy.has_popup;
  ...
  zaa.controller("PageBlockEditController", ['$scope', '$sce', '$http', 'AdminClassService', 'AdminToastService', 'ServiceBlockCopyStack', 'ServiceLiveEditMode', function ($scope, $sce, $http, AdminClassService, AdminToastService, ServiceBlockCopyStack, ServiceLiveEditMode) {
    ...
    $scope.minimizeBlock = function () {
      ...
      $http({
        ...
        params: {
          blockId: $scope.block.id,
          minimizedState: $scope.block.is_minimized
        }
      }).then(function (response) {
        /* load live url on hidden trigger */
        $scope.NavItemTypePageController.$parent.$parent.loadLiveUrl(); // successfull toggle hidden state of block
