 ...
 */
class UlBlock extends PhpBlock
{
    /**
    ...
    public function config()
    {
        return [
            'vars' => [
                ...
                ['var' => 'subClass', 'label' => Module::t('block_list_elements_label'), 'type' => self::TYPE_LIST_ARRAY],
            ...
            'placeholders' => [
                ['var' => 'elements', 'label' => 'Ul', 'type' => self::TYPE_LIST_ARRAY],
            ],
        ];
    }
    ...
    */
    ...
    {
        return '<h5 class="mb-3">Ul Block</h5>' .
