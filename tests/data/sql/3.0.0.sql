...
--
-- Host: 127.0.0.1    Database: luya_env_phpunit
-- ------------------------------------------------------
...
--
-- Dumping data for table `admin_queue`
--

LOCK TABLES `admin_queue` WRITE;
/*!40000 ALTER TABLE `admin_queue` DISABLE KEYS */;
/*!40000 ALTER TABLE `admin_queue` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `admin_queue_log` WRITE;
/*!40000 ALTER TABLE `admin_queue_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `admin_queue_log` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `admin_scheduler` WRITE;
/*!40000 ALTER TABLE `admin_scheduler` DISABLE KEYS */;
/*!40000 ALTER TABLE `admin_scheduler` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `admin_user` VALUES (1,'John','Doe',1,'test@luya.io','$2y$13$7TZy10K41AwgkIjn51OwFuHnafecDt.B5w/2RrA9frxExOh6biWRG','sWuayGA8P5PlEQBUirj0-BTdKimgQSj1',NULL,0,NULL,0,0,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0);
...
LOCK TABLES `admin_user_auth_notification` WRITE;
/*!40000 ALTER TABLE `admin_user_auth_notification` DISABLE KEYS */;
/*!40000 ALTER TABLE `admin_user_auth_notification` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `admin_user_request`
--

LOCK TABLES `admin_user_request` WRITE;
/*!40000 ALTER TABLE `admin_user_request` DISABLE KEYS */;
/*!40000 ALTER TABLE `admin_user_request` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `estore_config`
--
...
--
-- Dumping data for table `estore_config`
--

LOCK TABLES `estore_config` WRITE;
/*!40000 ALTER TABLE `estore_config` DISABLE KEYS */;
/*!40000 ALTER TABLE `estore_config` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `estore_currency`
--
...
--
-- Dumping data for table `estore_group`
--

LOCK TABLES `estore_group` WRITE;
/*!40000 ALTER TABLE `estore_group` DISABLE KEYS */;
/*!40000 ALTER TABLE `estore_group` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `estore_producer`
--
...
--
-- Dumping data for table `estore_producer`
--

LOCK TABLES `estore_producer` WRITE;
/*!40000 ALTER TABLE `estore_producer` DISABLE KEYS */;
/*!40000 ALTER TABLE `estore_producer` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `estore_product_attribute_value`
--
...
--
-- Dumping data for table `estore_product_attribute_value`
--

LOCK TABLES `estore_product_attribute_value` WRITE;
/*!40000 ALTER TABLE `estore_product_attribute_value` DISABLE KEYS */;
/*!40000 ALTER TABLE `estore_product_attribute_value` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `estore_product_group_ref`
--
...
--
-- Dumping data for table `estore_product_group_ref`
--

LOCK TABLES `estore_product_group_ref` WRITE;
/*!40000 ALTER TABLE `estore_product_group_ref` DISABLE KEYS */;
/*!40000 ALTER TABLE `estore_product_group_ref` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `estore_product_price`
--
...
--
-- Dumping data for table `estore_product_price`
--

LOCK TABLES `estore_product_price` WRITE;
/*!40000 ALTER TABLE `estore_product_price` DISABLE KEYS */;
/*!40000 ALTER TABLE `estore_product_price` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `estore_product_set_ref`
--
...
--
-- Dumping data for table `estore_product_set_ref`
--

LOCK TABLES `estore_product_set_ref` WRITE;
/*!40000 ALTER TABLE `estore_product_set_ref` DISABLE KEYS */;
/*!40000 ALTER TABLE `estore_product_set_ref` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `estore_set`
--
...
--
-- Dumping data for table `estore_set`
--

LOCK TABLES `estore_set` WRITE;
/*!40000 ALTER TABLE `estore_set` DISABLE KEYS */;
/*!40000 ALTER TABLE `estore_set` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `estore_set_attribute`
--
...
--
-- Dumping data for table `estore_set_attribute`
--

LOCK TABLES `estore_set_attribute` WRITE;
/*!40000 ALTER TABLE `estore_set_attribute` DISABLE KEYS */;
/*!40000 ALTER TABLE `estore_set_attribute` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `estore_set_attribute_ref`
--
...
--
-- Dumping data for table `estore_set_attribute_ref`
--

LOCK TABLES `estore_set_attribute_ref` WRITE;
/*!40000 ALTER TABLE `estore_set_attribute_ref` DISABLE KEYS */;
/*!40000 ALTER TABLE `estore_set_attribute_ref` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `scheduler_job_type`
--
...
--
-- Dumping data for table `scheduler_job_type`
--

LOCK TABLES `scheduler_job_type` WRITE;
/*!40000 ALTER TABLE `scheduler_job_type` DISABLE KEYS */;
/*!40000 ALTER TABLE `scheduler_job_type` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-08-29  7:33:52
